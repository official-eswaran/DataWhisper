...
class NL2SQLPipeline:
    ...
    def run(self, user_question: str) -> dict:
        ...
        # An aggregate threshold that became a row filter (#74). Order against
        # the two above is immaterial: this one requires no GROUP BY and no
        ...
        # A "how many X?" answered over rows rather than units (#60). Requires a
        # COUNT (or a bare column) that none of the four above leave behind.
